...
(function () {
  ...
  function injectStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = [
      // Colours come from LinkedIn's own theme tokens (the `theme--mercado`
      // CSS variables) so the panel follows light/dark automatically, in the
      // top frame and inside the /preload/ messaging iframe alike. Hardcoded
      // values are the light-mode fallbacks for surfaces where the tokens are
      // not defined (e.g. the invitations page, which themes via the
      // body[data-color-scheme] block kept further down instead).
      '#lf-panel {',
      ...
      '  color: var(--color-text, #1d2226);',
      '  border: 1px solid var(--color-border-faint, #d0d5da);',
      '  border-radius: 8px;',
      ...
      '  cursor: pointer;',
      '}',
      '#lf-panel .lf-btn:hover:not(:disabled) { background: var(--color-background-container-tint, #eaf3fb); }',
      ...
      '#lf-panel .lf-stop { border-color: var(--color-text-low-emphasis, #666); color: var(--color-text-low-emphasis, #666); }',
      '#lf-panel .lf-stop:hover:not(:disabled) { background: var(--color-background-container-tint, #f0f0f0); }',
      ...
      '#lf-panel .lf-pill--off { background: var(--color-background-container, #fff); border-color: var(--color-border-low-emphasis, #c4ccd3); color: var(--color-text-low-emphasis, #56687a); }',
      '#lf-panel .lf-pill--off:hover { background: var(--color-background-container-tint, #f0f0f0); }',
      ...
      '  border: 1px solid var(--color-border-faint, #d0d5da);',
      '  background: var(--color-background-container, #fff);',
      '  color: var(--color-text-low-emphasis, #56687a);',
      '  font-size: 15px;',
      '  line-height: 1;',
      '  cursor: pointer;',
      '}',
      '#lf-panel .lf-icon:hover { background: var(--color-background-container-tint, #f0f0f0); }',
      ...
      '  font-weight: 600;',
      '}',
      '#lf-panel .lf-hint { font-weight: 400; color: var(--color-text-low-emphasis, #8a949c); }',
